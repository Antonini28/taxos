...
**Built and running (R1):** ingestion, the deterministic VAT engine with lineage, the agent runtime, the approval gate, the audit chain, the fraud & risk centre, the one-click evidence pack, the grounded knowledge/research layer (Phase 4), and the executive dashboard — with tests, migrations, and a one-command demo.
